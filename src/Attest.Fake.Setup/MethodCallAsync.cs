...
namespace Attest.Fake.Setup
{
    ...
    public class MethodCallAsync<TService, T1, T2> :
        MethodCallBaseAsync<TService, IMethodCallback<T1, T2>>,
        IMethodCallInitialTemplateAsync<TService, IMethodCallback<T1, T2>, T1, T2>,
        ...
        IGenerateMethodCallback<T1, T2> where TService : class
    {
        ...
        /// <param name="runMethod">The run method.</param>
        /// <returns></returns>
        public static IMethodCallInitialTemplateAsync<TService, IMethodCallback<T1, T2>, T1, T2> 
            CreateMethodCall(Expression<Func<TService, Task>> runMethod)
        {
            return new MethodCallAsync<TService, T1, T2>(runMethod);
        }
        ...
        public IAddCallback<IMethodCallback<T1, T2>, T1, T2> Complete()
        {
            Callbacks.Add(
                CallbackBuilder
                    <ActionWrapper<T1, T2>, IMethodCallbackTemplate<IActionWrapper<T1, T2>, T1, T2>,
                        IMethodCallback<T1, T2>>.CreateCallbackBuilder()
                    .WithDefaultAction());
            return this;
        }
        ...
        /// <param name="buildCallbacks">The build callbacks.</param>
        /// <returns></returns>
        public IMethodCallAsync<TService, IMethodCallback<T1, T2>> BuildCallbacks(
            Func<IHaveNoCallbacks<IMethodCallback<T1, T2>, T1, T2>, 
                IHaveCallbacks<IMethodCallback<T1, T2>>> buildCallbacks)
        {
            buildCallbacks(this);
            return this;
        }

        IMethodCallAsync<TService, IMethodCallback<T1, T2>> 
            IMethodCallInitialTemplateAsync<TService, IMethodCallback<T1, T2>, T1, T2>
            .BuildCallbacks(Func<IHaveNoCallbacks<IMethodCallback<T1, T2>, T1, T2>, T1, T2, 
                IHaveCallbacks<IMethodCallback<T1, T2>>> callbacksProducer)
        {
            _callbacksProducer = callbacksProducer;
            return this;
        }
    ...
    public class MethodCallAsync<TService, T1, T2, T3> :
        MethodCallBaseAsync<TService, IMethodCallback<T1, T2, T3>>,
        IMethodCallInitialTemplateAsync<TService, IMethodCallback<T1, T2, T3>, T1, T2, T3>,
        ...
        IGenerateMethodCallback<T1, T2, T3> where TService : class
    {
        ...
        /// <param name="runMethod">The run method.</param>
        /// <returns></returns>
        public static IMethodCallInitialTemplateAsync<TService, IMethodCallback<T1, T2, T3>, T1, T2, T3> 
            CreateMethodCall(Expression<Func<TService, Task>> runMethod)
        {
            return new MethodCallAsync<TService, T1, T2, T3>(runMethod);
        }
        ...
        /// <param name="buildCallbacks">The build callbacks.</param>
        /// <returns></returns>
        public IMethodCallAsync<TService, IMethodCallback<T1, T2, T3>> BuildCallbacks(Func<IHaveNoCallbacks<IMethodCallback<T1, T2, T3>, T1, T2, T3>, IHaveCallbacks<IMethodCallback<T1, T2, T3>>> buildCallbacks)
        {
            buildCallbacks(this);
            return this;
        }
        ...
        IMethodCallAsync<TService, IMethodCallback<T1, T2, T3>> 
            IMethodCallInitialTemplateAsync<TService, IMethodCallback<T1, T2, T3>, T1, T2, T3>.BuildCallbacks(
            Func<IHaveNoCallbacks<IMethodCallback<T1, T2, T3>, T1, T2, T3>, T1, T2, T3, 
                IHaveCallbacks<IMethodCallback<T1, T2, T3>>> callbacksProducer)
        {
            _callbacksProducer = callbacksProducer;
            return this;
        }
    ...
    public class MethodCallAsync<TService, T1, T2, T3, T4> :
        MethodCallBaseAsync<TService, IMethodCallback<T1, T2, T3, T4>>,
        IMethodCallInitialTemplateAsync<TService, IMethodCallback<T1, T2, T3, T4>, T1, T2, T3, T4>,
        ...
        IGenerateMethodCallback<T1, T2, T3, T4> where TService : class
    {
        ...
        /// <param name="runMethod">The run method.</param>
        /// <returns></returns>
        public static IMethodCallInitialTemplateAsync<TService, IMethodCallback<T1, T2, T3, T4>, T1, T2, T3, T4> CreateMethodCall(Expression<Func<TService, Task>> runMethod)
        {
            return new MethodCallAsync<TService, T1, T2, T3, T4>(runMethod);
        }
        ...
        /// <param name="buildCallbacks">The build callbacks.</param>
        /// <returns></returns>
        public IMethodCallAsync<TService, IMethodCallback<T1, T2, T3, T4>> BuildCallbacks(Func<IHaveNoCallbacks<IMethodCallback<T1, T2, T3, T4>, T1, T2, T3, T4>, IHaveCallbacks<IMethodCallback<T1, T2, T3, T4>>> buildCallbacks)
        {
            buildCallbacks(this);
            return this;
        }
        ...
        IMethodCallAsync<TService, IMethodCallback<T1, T2, T3, T4>> IMethodCallInitialTemplateAsync<TService, IMethodCallback<T1, T2, T3, T4>, T1, T2, T3, T4>.BuildCallbacks(Func<IHaveNoCallbacks<IMethodCallback<T1, T2, T3, T4>, T1, T2, T3, T4>, T1, T2, T3, T4, IHaveCallbacks<IMethodCallback<T1, T2, T3, T4>>> callbacksProducer)
        {
            _callbacksProducer = callbacksProducer;
            return this;
        }
