namespace Attest.Fake.Setup.Contracts
{
    ...
    /// </summary>
    public interface IGenerateMethodCallbackConditionChecker
    {
        /// <summary>
        /// Trus, if the method callback can be generated, false otherwise.
        /// </summary>
        bool CanGenerateCallback { get; }
    }
    ...
    public interface IGenerateMethodCallback<T> : IGenerateMethodCallbackConditionChecker
    {                
        /// <summary>
        /// Generates callback.
        /// </summary>
    ...
    public interface IGenerateMethodCallback<T1, T2> : IGenerateMethodCallbackConditionChecker
    {
        /// <summary>
        /// Generates callback.
        /// </summary>
    ...
    public interface IGenerateMethodCallback<T1, T2, T3> : IGenerateMethodCallbackConditionChecker
    {
        /// <summary>
        /// Generates callback.
        /// </summary>
    ...
    public interface IGenerateMethodCallback<T1, T2, T3, T4> : IGenerateMethodCallbackConditionChecker
    {
        /// <summary>
        /// Generates callback.
        /// </summary>
    ...
    public interface IGenerateMethodCallback<T1, T2, T3, T4, T5> : IGenerateMethodCallbackConditionChecker
    {
        /// <summary>
        /// Generates callback.
        /// </summary>
