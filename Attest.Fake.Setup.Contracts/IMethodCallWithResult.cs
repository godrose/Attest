...
namespace Attest.Fake.Setup.Contracts
{
    ...
    /// <summary>
    /// Represents a service's method call with return value and run method
    /// </summary>
    /// <typeparam name="TService">Type of service</typeparam>
    /// <typeparam name="TResult">Type of return value</typeparam>
    public interface IMethodCallWithResult<TService, TResult> : IMethodCallWithResult<TService> where TService : class
    {
        /// <summary>
        /// Method to be called
        /// </summary>
